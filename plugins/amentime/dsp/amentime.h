 ...
 * File: amentime.h
 *
 * Tempo-synced amen-style break slicer for NTS-3.
 * A synthesized 1-bar break is stored as 12 kHz 8-bit PCM. Hold the pad to
 * play slices locked to host BPM (rate also tracks tempo, jungle-style).
 * X = start 16th, Y = slice grid (1/4 .. 1/32).
 */
...
class AmenTime : public Processor
{
public:
