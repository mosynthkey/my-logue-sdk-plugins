...
const messages = {
  en: {
    ...
    downloadAll: "Download all units",
    downloadAllBusy: "Preparing zip…",
    downloadAllError: "Could not build the zip.",
  ...
  ja: {
    ...
    downloadAll: "すべてのユニットをダウンロード",
    downloadAllBusy: "ZIPを準備しています…",
    downloadAllError: "ZIPを作成できませんでした。",
    loading: "プラグインを読み込み中…",
    preview: "プレビュー",
    latch: "ラッチ",
    hold: "ホールド",
