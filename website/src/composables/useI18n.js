...
export const japanesePluginDescriptions = {
  ...
  passort: "Performance Assortです。タッチ開始位置でエフェクトが決まり、その後の指の動きがそのパラメータになります。左上=HPF（右=カットオフ、下=レゾナンス）、右上=LPF（左=カットオフ、下=レゾナンス）、中央=テープストップ、左下=付点8分ディレイ（上=Depth、右=フィードバックHPF）、右下=ビート同期ステップロール（上=速さ、左=バッファ長）。Depthは全体のwet。離すとバイパス。",
