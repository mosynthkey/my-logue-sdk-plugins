...
export const japanesePluginDescriptions = {
  ...
  steprndflt: "テンポ同期のサンプル＆ホールドLFOをマルチモード・フィルタのカットオフへかけます。各ステップでランダム値を引き直し、Xは深さ、Yはレゾナンス（上限付き）。TYPEでLP12/LP24/BPF/HP12/HP24、LEVELでウェット→最終ソフトクリップ。パッドを押している間だけ効きます。",
