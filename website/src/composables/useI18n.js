...
export const japanesePluginDescriptions = {
  ...
  amentime: "合成した1小節のamen風ブレイクを、ホストBPMに合わせてスライス再生します。オリジナル録音は入っていません。パッドを押しているあいだ再生。Xは開始16分、Yはグリッド（1/4〜1/32）です。手元のWAVはWavSliceを使います。",
  wavslice: "任意の1小節WAVをホストBPMに合わせてスライス再生します。同梱はオリジナルのCC0ドラムループ。assets/loop.wav を置くか make embed WAV=... で差し替えます。",
  ...
  ukgarage: "テンポ同期の2-step UK Garageキットです。ホールドで走行。Xはゴーストノート（主ヒットのあいだの弱いスネア／リム）、Yはハット密度とFill感。右上フリックで1小節Fill。ゴーストがキモです。",
  ...
  trap808: "トラップ風ドラム＋スライドする808ベースです。ホールドで走行。Xはハイハット密度／ロール（8分→16分→32分・三連）、Yは808ルート音。右上フリックで1小節ハット・フィル。",
};
...
const messages = {
  en: {
    ...
    sendSlotHint: "Tap a {module} slot to send",
    log: "Log",
  ...
  ja: {
    ...
    cancel: "キャンセル",
    sendToSlot: "スロットへ送信",
    sendSlotHint: "{module}スロットをタップして送信",
    log: "ログ",
