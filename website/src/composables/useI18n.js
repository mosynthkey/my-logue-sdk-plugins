...
export const japanesePluginDescriptions = {
  ...
  stepgatedelay: "ユークリッド1/16ゲート＋テンポディレイです。パッドを押すと、いちばん近い16分クロックが相対ステップ0になります（Ride909方式）。Xは16ステップ中の密度、YはディレイのWet。デフォルトのディレイタイムは付点8分。フィードバックにハイ／ローダンプがあり、初期値ではローダンプが効いています。",
