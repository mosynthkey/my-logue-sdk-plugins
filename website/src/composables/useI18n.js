...
export const japanesePluginDescriptions = {
  ...
  trance: "テンポ同期のトランス・ドラムキットです。ハットはTR-909 ROM。ホールドはゲートのみで発音はビートロック。四つ打ち＋2と4のクラップ＋裏拍オープンハット。Xはハット、Yはビルド／クラップロール。右上フリックで1小節Fill。既定〜138 BPM。",
  drums: "ジャンル切替付きのテンポ同期ドラムキットです。ホールドはゲートのみで発音はビートロック。GENREで Trance / DnB / Breakbeat / UK Garage / Boom-bap / Dembow / Footwork を選択。Xは密度、YはFill感。右上フリックで1小節Fill。Trap808は別ユニットのままです。",
