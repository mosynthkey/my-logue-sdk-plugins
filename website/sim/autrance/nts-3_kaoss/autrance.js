...
function findWasmBinary() {
  return locateFile('autrance.wasm');
}
...
var ASM_CONSTS = {
  20948: ($0, $1) => { var ready = (typeof Module !== "undefined" && Module.onAudioReady) ? Module.onAudioReady : setupWebAudioAndUI; ready(emscriptenGetAudioObject($0), emscriptenGetAudioObject($1)); }
};
...
function assignWasmExports(wasmExports) {
  ...
  _unit_touch_event = Module['_unit_touch_event'] = wasmExports['unit_touch_event'];
