...
- **Acid303** — TB-303 style acid bass with auto phrase generator, `nts-3_kaoss` (`genericfx`, hold pad = tempo-synced 16-step pattern, retouch = new phrase). Voice inspired by gsynth TB-303 (Andy Sloane, 2001).
