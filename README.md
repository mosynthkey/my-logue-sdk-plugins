...
- **AirHorn** — DJ air horn (settled pitch D#4). Pitch envelope recreates the opening drop. NTS-1/mk2: PMODE Fixed|Key. NTS-3: DECAY (127=Sustain), PMODE Fixed|Pitch with PITCH ±2 oct on X. Targets `nts-1_mkii`, `nts-3_kaoss`, and `microkorg2`.
