...
- **TransitionLooper** — NTS-3 DJ transition looper: always captures AUDIO IN into a tempo-synced 16-step stereo loop plus wrap glue, even while the pad is up. Pad up bypasses; hold fades into the stored loop (volume, HPF/LPF, bass swap, echo out, brake, or roll).
