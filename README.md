...
- **TransitionLooper** — NTS-3 DJ transition looper: always holds a tempo-synced 16-step stereo loop plus wrap glue. Pad up bypasses; hold fades into the stored loop (volume, HPF/LPF, bass swap, echo out, brake, or roll).
